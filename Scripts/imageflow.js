...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        3.9,          /*1.964 Aspect ratio of the ImageFlow container (width divided by height) */
...
domReady(function()
{
	...
	instanceOne.init({ ImageFlowID: 'gallery', reflections: false, buttons: true, captions: false, imageCursor: "pointer", aspectRatio: 4.2,
	    imagesM: 0.9,
	    xStep: 80,
	    percentLandscape: 66,
	    percentOther: 50,
